                                            ...
                                            <div class="mt-3 mt-lg-0">
                                                <form action="javascript:void(0);">
                                                    <div class="row g-3 mb-0 align-items-center">
                                                        ...
                                                        <!--end col-->
                                                        <div class="col-auto">
                                                            <a href="{{route('user.edit.profile',['id'=>Auth::user()->id])}}" type="button" class="btn btn-soft-primary material-shadow-none"><i class="ri-add-circle-line align-middle me-1"></i> Edit Profile</a>
                                                        </div>
                                                        <!--end col-->
                                                        <div class="col-auto">
                                    ...
                                    <div class="card-body p-0">
                                        ...
                                        <div class="p-3 mt-2">
                                            ...
                                            <ol class="ps-3 text-muted">
                                                <li class="py-1">
                                                    <a href="index.html#" class="text-muted">Mobile & Accessories <span class="float-end">(10,294)</span></a>
                                                </li>
                                                <li class="py-1">
                                                    <a href="index.html#" class="text-muted">Desktop <span class="float-end">(6,256)</span></a>
                                                </li>
                                                <li class="py-1">
                                                    <a href="index.html#" class="text-muted">Electronics <span class="float-end">(3,479)</span></a>
                                                </li>
                                                <li class="py-1">
                                                    <a href="index.html#" class="text-muted">Home & Furniture <span class="float-end">(2,275)</span></a>
                                                </li>
                                                <li class="py-1">
                                                    <a href="index.html#" class="text-muted">Grocery <span class="float-end">(1,950)</span></a>
                                                </li>
                                                <li class="py-1">
                                                    <a href="index.html#" class="text-muted">Fashion <span class="float-end">(1,582)</span></a>
                                                </li>
                                                <li class="py-1">
                                                    <a href="index.html#" class="text-muted">Appliances <span class="float-end">(1,037)</span></a>
                                                </li>
                                                <li class="py-1">
                                                    <a href="index.html#" class="text-muted">Beauty, Toys & More <span class="float-end">(924)</span></a>
                                                </li>
                                                <li class="py-1">
                                                    <a href="index.html#" class="text-muted">Food & Drinks <span class="float-end">(701)</span></a>
                                                </li>
                                                <li class="py-1">
                                                    <a href="index.html#" class="text-muted">Toys & Games <span class="float-end">(239)</span></a>
                                                </li>
                                            </ol>
