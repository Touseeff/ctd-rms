...
<div class="app-menu navbar-menu">
    ...
    <div class="navbar-brand-box">
        <!-- Dark Logo-->
        <a href="{{ route('hr.dashboard') }}" class="logo logo-dark">
            <span class="logo-sm">
            ...
            <span class="logo-lg">
                <img src="{{ asset('./public/assets/images/logo-dark.p') }}ng" alt="" height="17"
                    style="    margin-right: 12px; margin-top: 30px; width: 108px; height: 40px;">
            </span>
        </a>
        <!-- Light Logo-->
        <a href="{{ route('hr.dashboard') }}" class="logo logo-light">
            <span class="logo-sm">
                <img src="{{ asset('./public/assets/images/logo-sm.png') }}" alt="" height="22">
            </span>
            <span class="logo-lg">
